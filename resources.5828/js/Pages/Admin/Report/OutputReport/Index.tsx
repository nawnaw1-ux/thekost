...
const Index = ({ allTransactions }: Props) => {
    // Get current month and year as default value
            ...
            <div className="flex items-center justify-end">
                <div className="flex items-center gap-2.5">
                    ...
                    <Input
                        ...
                        className="input input-sm bg-white dark:bg-zinc-800 border border-gray-300 dark:border-gray-500"
...
Index.layout = (page: React.ReactNode) => (
    <AdminLayout head="Laporan Pengeluaran" children={page} />
);

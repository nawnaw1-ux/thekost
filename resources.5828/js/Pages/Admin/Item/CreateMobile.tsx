...
const CreateMobile: React.FC = () => {
    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            <DialogTrigger className="fixed right-6 z-20 bottom-20">
                <Button className="flex md:hidden justify-center  px-3 py-6 bg-white dark:bg-zinc-900 border border-gray-300 dark:border-gray-500 rounded-full  text-primary  items-center">
                    <Plus size={24} />
                </Button>
            </DialogTrigger>
            <DialogContent>

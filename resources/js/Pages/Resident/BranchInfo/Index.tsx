...
const Index = ({ boardingBranch, bankAccount }: Props) => {
        ...
        <div className="flex  lg:px-56  mt-2 flex-col w-full">
            ...
            <div className="w-full pb-6">
                <div className="pt-2 pb-2">
                    ...
                    <p className="text-sm text-muted-foreground">
                        Gunakan rekening berikut untuk melakukan pembayaran kos
                    </p>
                </div>
                <div className="w-full rounded-md p-8 border-2 border-primary/60 bg-primary/10 shadow-[0_0_0_1px_rgba(99,102,241,0.15)]">
                    {bankAccount ? (
                        ...
                        <p className="text-sm text-primary/80">
                            Informasi bank account belum tersedia.
                        </p>
                    )}
                </div>
            </div>

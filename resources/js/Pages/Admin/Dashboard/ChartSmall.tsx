...
const chartData = [
    { browser: "safari", visitors: 60, fill: "hsl(var(--chart-1))" },
];
...
export function ChartSmall({ paid, paidPercentage, money }: Props) {
    const circle = 360;
            ...
            <div className="flex   w-14  max-w-[250px] mx-auto">
                ...
                >
                    <RadialBarChart
                        ...
                        innerRadius={25} // menggunakan persentase untuk fleksibilitas
                        outerRadius={42} // fleksibilitas
                    >
                        <PolarGrid
                            gridType="circle"
                            radialLines={false}

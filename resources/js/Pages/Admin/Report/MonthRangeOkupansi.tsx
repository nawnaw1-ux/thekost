...
const MonthRangeOkupansi = ({ groupedResidentYear }: Props) => {
    const initialYear =
        groupedResidentYear.length > 0 ? groupedResidentYear[0].year : "";
    ...
    const handleYearChange = (event: React.ChangeEvent<HTMLSelectElement>) => {
        ...
        router.post(
            route("admin.report.okupansiResident"),
            {
...
export default MonthRangeOkupansi;
